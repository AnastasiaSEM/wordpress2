...
<?php if ((empty($icon_data) || empty($icon_data['icons'])) && empty($landing_page_config['icons'])) : ?>
    <p>It seems you don't have any icon pack loaded yet.
        <a target="_blank" href="<?php echo admin_url('admin.php?page=thrive_icon_manager') ?>" class="tve_lightbox_link tve_lightbox_link_create">Click here</a> to add
        your first icon pack.
    </p>
<?php else : ?>
