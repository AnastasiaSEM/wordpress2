...
<div class="tve_lightbox_frame" id="tve_lightbox_frame">
    ...
    <div class="tve_lightbox_buttons tve_clearfix" id="tve_lightbox_buttons">
        <input type="button" class="tve_save_lightbox tve_mousedown tve_editor_button tve_editor_button_success tve_right" value="Save" data-ctrl="controls.lb_save">
    </div>
</div>
...
<div style="display: none" id="tve_static_elements">
    ...
    <div data-elem="sc_social_default">
        <div class="thrv_wrapper thrv_social thrv_social_default" data-tve-style="default">
            ...
            <div class="thrive-shortcode-config" style="display: none !important"><?php echo '__CONFIG_social_default__' . json_encode($defaults) . '__CONFIG_social_default__' ?></div>
