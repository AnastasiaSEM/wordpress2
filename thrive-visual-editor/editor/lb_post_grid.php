...
<div class="tve_post_grid_tabs_container">
    ...
    <div class="tve_scT tve_green">
        ...
        <div class="tve_scTC tve_scTC1 tve_clearfix" style="display: block">
            <div class="tve_options_wrapper tve_clearfix">
                <div class="tve_option_container tve_clearfix">
                    ...
                    <div class="tve_fields_container">
                        <div class="tve_lightbox_input_holder">
                            ...
                            <label for="tve_pg_featured_image">Featured image</label>
                        </div>
                        ...
                        <div class="tve_lightbox_input_holder">
                            ...
                            <label for="tve_pg_title">Title</label>
                        </div>
                        ...
                        <div class="tve_lightbox_input_holder">
                            ...
                            <label for="tve_pg_text">Text</label>
                        </div>
                        <div class="tve_lightbox_input_holder">
                            ...
                            <label for="tve_pg_read_more">Read more link</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="tve_option_container tve_clearfix">
                    ...
                    <div class="tve_fields_container">
                        <p><?php echo __("Drag the items into the correct order for display:") ?></p>
                    ...
                    <div class="tve_fields_container">
                        <div class="tve_lightbox_select_holder">
                            <select name="grid_layout">
                                <option
                                    value="horizontal" <?php echo empty($_POST['grid_layout']) || $_POST['grid_layout'] === 'horizontal' ? 'selected="selected"' : '' ?>><?php echo __('Horizontal') ?></option>
                                <option
                                    value="vertical" <?php echo !empty($_POST['grid_layout']) && $_POST['grid_layout'] === 'vertical' ? 'selected="selected"' : '' ?>><?php echo __('Vertical') ?></option>
                            </select>
                        </div>
                ...
                <div class="tve_option_container tve_clearfix">
                    ...
                    <div class="tve_fields_container">
                        <input maxlength="3"
                               ...
                               class="tve_lightbox_input tve_lightbox_input_inline"/> <?php echo __('Days') ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tve_scTC tve_scTC3 tve_clearfix">
            <div class="tve_options_wrapper tve_clearfix">
                <div class="tve_option_container tve_clearfix">
                    <h4>Choose which content to include</h4>
