...
<ul class="tve_menu">
    ...
    <li class="tve_text clearfix">
        <input class="tve_change tve_left tve_checkbox_bottom" type="checkbox" id="table_make_sortable"
               value="1"><label for="table_make_sortable"
                                class="tve_left">Make table sortable</label>
    </li>
