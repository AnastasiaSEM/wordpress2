        ...
        fb_share: {
            ...
            validateAppID: function ($link) {
                ...
                function app_id_invalid() {
                    TVE_Content_Builder.social.showErrors([{
                        ...
                        field: 'app_id',
                        message: 'Error validating the ID. Please check your input and try again'
                    }]);
                }
            ...
            validate_custom: function (config) {
                if (config.type == 'feed' && !tve_path_params.social_fb_app_id) {
                    return [{
                        tab: 'fb_share',
                        message: 'Please set a correct App ID and validate it using the "Validate App ID" button',
                        field: 'app_id'
                    }];
                }
            }
        ...
        t_share: {
            ...
            validate: function (config) {
                if (this.setup.tweetLength() < 0) {
                    return [{
                        tab: 't_share',
                        message: 'The tweet contains too many characters. Please shorten your message',
                        field: 'tweet'
                    }];
                }
            }
