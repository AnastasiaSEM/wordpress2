...
class Thrive_Api_Html_Renderer
{
    ...
    protected function _tableHead()
    {
        ...
        <?php if ($this->show_order) : ?><th width="5%">&nbsp;</th><?php endif ?>
            <th style="width: 10%; text-align: center"><?php $this->show_display_options ? _e('Display', 'thrive-visual-editor') : _e('Field Number', 'thrive-visual-editor'); ?></th>
            <th style="width: 17%;"><?php _e("Field Properties", "thrive-visual-editor"); ?></th>
            <th style="width: 25%;"><?php _e("Field Label / Description", "thrive-visual-editor"); ?></th>
            <th style="width: 16%;"><?php _e("Validation", "thrive-visual-editor") ?></th>
            <th style="width: 11%;"><?php _e("Required Field", "thrive-visual-editor"); ?></th>
            <th><?php _e('Show Icon', "thrive-visual-editor") ?></th>
        </tr></thead><?php
