<div id="thrive-api-list">
    ...
    <?php if (!empty($selected_api)) : ?>
        ...
        <?php else : ?>
            ...
            &nbsp;&nbsp;&nbsp;
            <a href="javascript:void(0)" class="tve_click tve_lightbox_link tve_lightbox_link_refresh" data-ctrl="function:auto_responder.api.reload_lists" data-force-fetch="1"" data-api="<?php echo $selected_api->getKey() ?>">Reload</a>
            <?php if (!empty($lists)) : ?>
