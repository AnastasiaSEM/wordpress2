...
<table>
    ...
    <tr<?php if (empty($config['e_mobile'])) echo ' class="tve_hidden"' ?> id="e_use_mobile">
        <td width="35%">
            It is not possible to detect exit intent on a mobile device, so instead the selected action will be
            performed after a time delay. How long after page load
